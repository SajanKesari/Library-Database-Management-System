...
-- (Not putting primary keys as they are Auto-incremented)
-- (Also the data was generated by AI for cohesive queries)
...
-- 4. Populate the Members Table (Adding members first and last name, cause lot of libraries follow this rule in order to generate personalized messages)
